...
import paymentImg from "../../../assets/solutions/Payment.webp";
...
const PaymentGateway = () => {
  ...
  const features = [
    {
      icon: <RiSecurePaymentLine className="text-4xl text-[#ff8402]" />,
      title: "Secure Payments",
      description:
        "Bank-level security with PCI DSS compliance and end-to-end encryption for all transactions",
    },
    {
      icon: <FaSync className="text-4xl text-[#ff8402]" />,
      title: "Instant Processing",
      description:
        "Real-time payment processing with immediate fund transfer and settlement capabilities",
    },
    {
      icon: <RiGlobalLine className="text-4xl text-[#ff8402]" />,
      title: "Multi-Currency",
      description:
        "Accept payments in multiple currencies with automatic conversion and competitive rates",
    },
    {
      icon: <FaMobileAlt className="text-4xl text-[#ff8402]" />,
      title: "Mobile Optimized",
      description:
        "Seamless payment experience across all mobile devices and digital platforms",
    },
    {
      icon: <RiDashboardLine className="text-4xl text-[#ff8402]" />,
      title: "Advanced Dashboard",
      description:
        "Comprehensive analytics and real-time reporting for all transaction activities",
    },
    {
      icon: <RiRefundLine className="text-4xl text-[#ff8402]" />,
      title: "Easy Refunds",
      description:
        "Simple and quick refund processing with automated customer notifications",
    },
  ];
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      icon: <FaCreditCard className="text-3xl text-[#ff8402] mb-4" />,
      popular: true,
    },
    {
      ...
      icon: <FaShieldAlt className="text-3xl text-[#ff8402] mb-4" />,
    },
  ];

  const benefits = [
    "PCI DSS Level 1 certified security with bank-grade encryption",
    "99.9% uptime guarantee with SLA-backed reliability",
    "Instant payment settlement with real-time processing",
    "Support for all major payment methods and cards",
  ...
  const useCases = [
    {
      ...
      description: "Secure online payments for retail and wholesale businesses",
      icon: <FaGlobe className="text-2xl text-[#ff8402]" />,
    },
    {
      title: "Subscription Services",
      description: "Recurring billing for SaaS and subscription businesses",
      icon: <FaSync className="text-2xl text-[#ff8402]" />,
    },
    {
      title: "Digital Products",
      description: "Instant payment processing for digital goods and services",
      icon: <RiMoneyDollarCircleLine className="text-2xl text-[#ff8402]" />,
    },
    {
      title: "Marketplaces",
      description: "Multi-vendor payment solutions for online marketplaces",
  ...
  .glow-border-bottom {
    width: 600px !important;
      ...
      <section className="relative w-full h-[300px] md:h-[50vh] overflow-hidden">
        ...
        <header className="relative z-10 text-center flex flex-col justify-center items-center h-full px-6">
          ...
          <p className="text-xs sm:text-lg text-gray-300 max-w-2xl mx-auto">
            Secure, reliable payment processing solution for your business.
            Accept payments from anywhere in the world with bank-level security
            and confidence.
          </p>
        </header>
      </section>
      ...
      <div className="relative mx-auto w-full md:py-20 grid-bg-pattern">
        ...
        <div className="content-layer payment-content">
          <section className="tech-container p-4 md:p-8 mb-4 md:mb-16 w-11/12 md:w-9/12 mx-auto first-card-position -mt-12 md:-mt-20">
            <div className="text-left md:text-center">
              ...
              <p className="text-xs md:text-lg text-gray-300 mt-2 tech-blue">
                Bank-Level Security • Multi-Currency • Instant Settlement
              </p>
            </div>
          </section>
          ...
          <div className="relative w-11/12 md:w-9/12 mx-auto mb-6 mt-8 md:mt-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  <div className="feature-icon payment-icon-hover">
          ...
          <section className="tech-container p-4 md:p-8 mb-4 md:mb-6 w-11/12 md:w-9/12 mx-auto">
            <div className="text-center mb-4 md:mb-8 xl:mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white ">
                Affordable <span className="text-white">Payment Plans</span>
              </h2>
              <p className="text-gray-300 text-base md:text-lg max-w-3xl mx-auto">
                Choose the perfect payment processing package for your business
                transaction needs
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 ">
              {pricingPlans.map((plan, index) => (
                <div
                  key={index}
                  className={`tech-container p-8 text-center relative payment-pricing-hover ${
          ...
          <section className="tech-container p-4   mb-4 md:mb-6 w-11/12 md:w-9/12 mx-auto">
            <div className="text-center  mb-4 md:mb-8 xl:mb-12 ">
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                Versatile payment solutions for different business models and
                industries
              </p>
            </div>
            ...
            <div className="use-case-grid ">
              {useCases.map((useCase, index) => (
                <div
                  key={index}
                  className="tech-container p-4 use-case-hover"
                  style={{ position: "relative", zIndex: 35 }}
                >
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-white ">
                  Why Choose{" "}
                  <span className="text-white">Musking Payments</span>
                </h2>
              ...
              <div className="flex justify-center">
                <div className="p-4 rounded-xl bg-[#0d1117]/50 shadow-inner">
                  <img
                    src={paymentImg}
                    alt="Payment gateway integration dashboard showing transaction processing, security features, and multiple payment method options"
          ...
          <section className="tech-container p-4   md:-mb-10 w-11/12 md:w-9/12 mx-auto last-card-position ">
            <div className="text-center">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white t">
                Ready to{" "}
                <span className="text-white">Start Accepting Payments</span>
              </h2>
              <p className="text-gray-300 text-lg mb-8">
                Join thousands of businesses that trust our secure payment
                gateway solution for their transactions
              </p>
              ...
              <p className="text-gray-400 text-sm mt-4">
                * Free setup • No long-term contracts • 30-day money-back
                guarantee
              </p>
            </div>
          </section>
