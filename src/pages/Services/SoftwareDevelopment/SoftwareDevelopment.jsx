    ...
    projects: [
      {
        ...
        name: "ERP System Pro",
        description:
          "A comprehensive Enterprise Resource Planning system designed to streamline business operations. Features include inventory management, financial tracking, HR management, and real-time analytics.",
        url: "https://erp-system-pro.vercel.app/",
        github: "#",
      ...
      {
        id: 2,
        name: "CRM Solution Plus",
        description:
          "A powerful Customer Relationship Management platform that helps businesses manage customer interactions, track sales pipelines, and improve customer satisfaction. Built with modern technologies for scalability.",
        url: "https://crm-solution-plus.vercel.app/",
        github: "#",
        image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800",
        technologies: ["Vue.js", "Python", "Django", "MongoDB", "Azure"],
        features: [
          "Customer Database",
          "Sales Pipeline",
          "Task Management",
          ...
          <section className="tech-container p-6 md:p-8 mb-8 w-11/12 md:w-9/12 mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 text-sm md:text-base mt-4 max-w-2xl mx-auto">
                Explore our recent software development projects that showcase our expertise
                in building scalable, secure, and high-performance enterprise solutions.
              </p>
            </div>
