      ...
      <div className="cyber-security-container w-9/12 mx-auto">
        <div className="main-content">
          ...
          <div className="relative w-full h-full">
            <h1 className="vertical-title absolute  right-[355px]  top-[360px]  -translate-y-1/2 rotate-270 origin-left tracking-[6px] text-[#FF730F] text-2xl z-50">
              FACERECOGNITION
            </h1>
          </div>

          <div
            className="info-card w-64 roundedcursor-move bg-[#110c11] shadow-3xl flex flex-col items-center gap-2 absolute"
            style={{
              bottom: "300px",
              right: "110px",
            }}
          >
            {/* Profile Image */}
            <img
              className="w-16 h-16 border-2 border-black mt-2 "
              src={faceImage}
              alt="Profile"
            />
            ...
            {/* Detected Button */}
            <button className="mt-2 text-white bg-green-800 py-1 px-3 rounded font-bold hover:bg-green-700 transition-colors ">
              Detected
            </button>
          </div>

          <div className="flex items-start justify-between p-6 flex-wrap">
            {/* Left Section - Main Image */}
            <div className="image-section flex-shrink-0">
              <img
                className="mt-12 object-cover rounded-lg shadow-lg w-full max-w-[320px] h-auto"
                src={faceImage}
            ...
            <div className="svg-container">
              ...
              >
                ...
                <defs>
                  <clipPath id="clip0_3659_4639">
                    <rect
                      fill="white"
                      height="231"
                      width="210"
                      transform="translate(602 186)"
                    />
                  </clipPath>

                  {/* Add all other clip paths and gradients... */}
                </defs>
              </svg>
            </div>
          </div>
