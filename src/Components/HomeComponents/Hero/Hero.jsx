...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    let scroll = 0;
     const speed = 0.5; // marquee speed set 
  ...
  return (
    <section className="hero-section relative bg-black text-white h-screen flex flex-col justify-between items-center overflow-hidden">
  ...
  {/* Main Hero Content */}
  <div className="relative z-10 w-9/12 mx-auto flex flex-col-reverse lg:flex-row items-center gap-8 flex-1">
    {/* Left Content */}
    <div className="flex-1 flex flex-col justify-center text-center lg:text-left">
      ...
      <h1 className="text-xl sm:text-4xl md:text-4xl font-bold text-[#0072bc] leading-snug mb-2">
        Elite Web Development & <br /> Professional IT Services <br />
        in{" "}
      ...
      <div className="mt-6 flex gap-6 justify-center md:justify-start text-2xl">
        ...
        >
         ...
         <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-[#f56ed8] transition-colors"
        >
          <FaInstagram />
        </a>
      </div>
  ...
  {/* Stats */}
  <div className="relative z-10 w-9/12 mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 rounded bg-white/20 shadow-lg">
    {stats.map((stat) => (
      <div
        key={stat.id}
  ...
  {/* Marquee */}
  <div className="relative z-10 mx-auto overflow-hidden border-t border-b border-white/20 py-4 backdrop-blur-sm rounded-lg w-full mt-20">
    <div ref={marqueeRef} className="flex whitespace-nowrap gap-8">
      <span className="fjalla-font text-gray-300 text-xl bg-black/40 px-2">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
        suscipit, justo ac fermentum placerat, sapien neque tempus elit, a
        viverra ligula nunc nec mauris.justo ac fermentum placerat, sapien neque tempus elit, a
