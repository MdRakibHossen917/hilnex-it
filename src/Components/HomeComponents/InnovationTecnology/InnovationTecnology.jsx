...
import "./InnovationTecnology.css";
import riskOne from "../../../assets/riskOne.png";
import riskTwo from "../../../assets/riskTwo.png";
import faceImgInno from "../../../assets/face.jpg";

const InnovationTecnology = () => {
  return (
    <div
    ...
    >
      <div className="flex justify-content items-center w-9/12 mx-auto  ">
        <div className="translate-y-[55px] translate-x-[20px]">
          <img
            src={faceImgInno}
        ...
        <div className="elementor-widget-container my-20">
          <div>
            <h1 className="font-bold text-xl text-[#FF730F] rotate-270 origin-left tracking-[30px] translate-y-[600px]">
              FACE RECOGNITION
            </h1>
          </div>
          ...
          <div className="left-image-container absolute bottom-0 left-0 ">
            <img
              src={riskTwo}
              alt="Risk One"
              className="risk-image risk-one ml-360 mb-30"
              style={{ height: "300px", width: "200px", objectFit: "cover" }}
            />
          </div>

          <div>
            <h2 className="text-lg font-bold text-blue-800 relative ml-190 translate-y-[340px]">
              <br />  <br />
            </h2>
          </div>
          </div>
...
export default InnovationTecnology;
