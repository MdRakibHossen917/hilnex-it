...
import "./FaceRecognitionAnimationLargeDevice.css";
import faceImage from "../../../assets/face.jpg";
import NonFaceMask from "../../../assets/Brand/NonFaceMask.png";
import CellEffect from "../../CellEffect/CellEffect";
import { FiCheck, FiMail, FiPhone } from "react-icons/fi";
import IdCard from "../../../assets/Brand/IdCard.png";
import IdCardLarge from "../../../assets/Brand/LiveDetectionTwo.png";
import LiveDetection from "../../../assets/Brand/LiveDetection.png";
import LiveDetectionOne from "../../../assets/Brand/LiveDetection.png";

const FaceRecognitionAnimationLargeDevice = () => {
  // Configurations
  const isLargeScreen =
    typeof window !== "undefined" && window.innerWidth >= 1024;

  const totalLines = 20;
  const imageHeight = 431;
  const startY = 5;
  ...
  const orangeEndX = isLargeScreen ? cardX + 100 : cardX;

  const blueStartX = cardX + cardWidth;
  const blueEndX = 666;
  ...
  const gridBackgroundStyle = {
    backgroundImage: `
      linear-gradient(90deg, #1b203c 1px, transparent 1px),
      linear-gradient(#1b203c 1px, transparent 1px)
    `,
  ...
  return (
    <div className="hidden lg:block relative w-full h-[800px] bg-[#000000] flex flex-col justify-center items-center overflow-hidden">
      {/*Background Grid + CellEffect*/}
      <div
      ...
      <div className="relative z-10 text-center mt-4">
        <h1 className="text-xl   tracking-widest uppercase animated-heading text-center mt-10">
          <h1 className="text-xl   tracking-widest uppercase text-center text-[#e7e5e5]">
            Face
          </h1>
        ...
        <p className="text-xl text-[#ffffff] font-light tracking-wider mt-5 max-w-xl mx-auto leading-relaxed">
          Our AI-powered system identifies and verifies faces instantly. <br />
          No setup required — just scan or upload to see results in real-time.
        </p>
      </div>

      {/* Main Content: Vertical on mobile, horizontal on large screens */}
      <div className="relative z-20 w-full md:w-9/12 mx-auto flex flex-col items-center justify-start lg:flex-row lg:justify-between lg:items-center lg:translate-x-[0px] mt-10 lg:mt-0   ">
        {/* Left Face Image */}
        <div className="flex-shrink-0 mb-4 lg:mb-0 lg:mr-8">
          <img
            src={imgSrc}
            alt="faceImage"
            className="w-4/5 mx-auto max-w-[325px] lg:max-w-none md:w-[320px] lg:w-[400px] xl:w-[480px] rounded shadow-3xl   lg:-mt-2"
          />
        </div>

        {/* Vertical Text */}
        <div className="flex items-center justify-center h-auto w-full lg:h-[530px] lg:w-5 lg:-mt-4 lg:py-0 flex-shrink-0">
          <h1 className="font-bold text-xl text-[#FF730F] whitespace-nowrap uppercase -mt-[22px] lg:mt-1 lg:rotate-[270deg] tracking-[2.7px] md:tracking-[5.5px] lg:tracking-[8px] xl:tracking-[11px] mr-16">
            Face Identification
          </h1>
        </div>

        {/* Middle SVG Animation */}
        <div className="flex-1 flex justify-center items-center relative w-full h-auto lg:h-full max-w-[580px] mx-auto rotate-[90deg] md:rotate-[90deg] lg:rotate-0 -mt-40 lg:mt-0 lg:-mx-8">
          <svg
            className="w-full max-w-[370px] md:max-w-none md:w-[450px] xl:w-[580px] h-auto"
            viewBox={`0 0 600 ${imageHeight}`}
            fill="none"
          ...
          >
            ...
            <defs>
              ...
              >
                <stop offset="0%" stopColor="#FF730F" stopOpacity="1" />
                <stop offset="100%" stopColor="#FF730F" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                id="blueLine"
                x1="100%"
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset="0%" stopColor="#2296DD" stopOpacity="1" />
                <stop offset="100%" stopColor="#2296DD" stopOpacity="0" />
              </linearGradient>
            </defs>

            {/* Orange Lines and Dots */}
            <g>
              {Array.from({ length: totalLines }, (_, i) => {
                ...
                return (
                  <React.Fragment key={`orange-${i}`}>
                    <path
                      d={`M${orangeStartX},${y}L${orangeEndX},${y}`}
                    ...
                    <circle fill="#FF730F" r="2" opacity="0">
                      ...
                      />
                      <animateMotion
                        begin={`${delay}s;${id}.end+0.1s`}
                        dur="1.5s"
                        repeatCount="indefinite"
                        id={id}
                        path={`M${orangeStartX},${y}L${orangeEndX},${y}`}
                      />
                      <animate
                        attributeName="opacity"
                        from="0"
            ...
            {/* Blue Lines (SVG Paths) and Dots (Animation logic kept as is) */}
            <g transform="translate(-90, -90)">
              <path
                ...
                fill="none"
              ></path>
              <circle className="blue-circle" fill="#2296DD" opacity="1" r="2">
                <animateMotion
              ...
              <path
                d="M317 397.67C337.26 397.69 357.82 398.37 377.91 396.94C382.1 396.65 386.24 396.28 390.32 395.79C405.37 394.04 418.98 390.67 432.16 386.87C438.92 384.9 445.46 382.73 451.85 380.61C453.05 380.21 454.24 379.81 455.43 379.4C470.7 374.19 551.07 344.29 554.99 343.04"
                stroke="#2296DD"
                strokeWidth="1.5"
                fill="none"
              ></path>
        ...
        {/* Right ID Card */}
        <div className="flex-shrink-0 mt-3 lg:mt-0  lg:-translate-x-[110px] z-20 flex flex-col items-center justify-center">
          {/* Mobile / Tablet */}
          <div className="md:hidden w-[275px] h-[170px] flex flex-col items-center justify-center shadow-lg">
            <img
              src={IdCard}
              alt="ID Card"
              className="w-full h-auto object-contain -mt-58"
            />
          </div>

          <div className="hidden lg:flex xl:flex id-card rounded-lg  flex flex-col items-center justify-center shadow-2xl relative overflow-hidden">
            <div className="flex flex-col items-center justify-center shadow-lg">
              <img
                src={IdCardLarge}
                alt="ID Card Large"
                className="  lg:h-[375px]  h-[450px] object-contain mr-30"
              />
            </div>
          </div>
        </div>
...
export default FaceRecognitionAnimationLargeDevice;
